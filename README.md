...
2. [mir_eval: A TRANSPARENT IMPLEMENTATION OF COMMON MIR METRIC](https://colinraffel.com/publications/ismir2014mir_eval.pdf)
3. [JAMS DOCUMENTATION](https://jams.readthedocs.io/en/stable/)
...
5. [ESSENTIA: AN AUDIO ANALYSIS LIBRARY FOR MUSIC
INFORMATION RETRIEVAL](https://repositori.upf.edu/server/api/core/bitstreams/df79c17b-865f-4313-a440-e0d1e5cbf234/content)
6. [criterion.rs documentation](https://bheisler.github.io/criterion.rs/book/criterion_rs.html)
...
8. [Transpiling Python to Rust for Optimized
Performance](https://trepo.tuni.fi/bitstream/handle/10024/217564/transpiling_python_to_rust_for_optimized_performance.pdf?sequence=1)
9. [py2many: Python to Rust, C++, Go, Zig, Mojo & More - Universal Python Transpiler](https://github.com/py2many/py2many)
10. [Python to Rust transpiler](https://github.com/konchunas/pyrs)
11. 
